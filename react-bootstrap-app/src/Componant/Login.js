...
import {Button, FormGroup, FormControl, ControlLabel, Col} from "bootstrap";
...
class Login extends Component {
  constructor(props) {
    ...
    if(user_data && user_data !== "{}"){
      username = JSON.parse(user_data).username;//pour acceder a elements dans yser data.name comme objet java; 
